    ...
    public void createPartControl(Composite parent) {
        ...
        saveItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(final SelectionEvent event) {
                ...
                TreeViewPart treeViewPart = (TreeViewPart) window
                        .getActivePage().findView("RAP-FirstProject.project");
                final ControlDecoration dec = new ControlDecoration(
                        versionText, SWT.TOP | SWT.LEFT);
                dec.setImage(PlatformUI.getWorkbench().getSharedImages()
                        .getImage(ISharedImages.IMG_DEC_FIELD_ERROR));
                // dec.setShowOnlyOnFocus(true);
                dec.hide();
                if (isFirst == true) {
                    List<Version> versions = version.getEquipment()
                            .getVersions();
                    ...
                    if(!isDuplicateName){
                        MessageDialog dg = new MessageDialog(
                                ...
                                "My title",
                                null,
                                "Do you want to save change this version?",
...
//                            equipment.removeVersion(version);
        ...
        targetVersionText = toolkit.createText(form.getBody(), "", SWT.NONE);
            ...
            public void selectionChanged(IWorkbenchPart part,
                ...
                if (element != null) {
                    if (element instanceof Version) {
                        ...
                        deployTime = dateformatJava.format(version
                                .getDeployTime());
